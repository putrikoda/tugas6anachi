...
public class activity_registrasi extends AppCompatActivity {
    ...
    public void InsertDataIntoSQLiteDatabase(){
        if(EditTextEmptyHolder == true)
        {
            ...
            AlertDialog.Builder builder = new
                    AlertDialog.Builder(activity_registrasi.this);
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(activity_registrasi.this,"Email Already Exists", Toast.LENGTH_LONG).show();
        }
        else {
    ...
    public void Beck(View view) {
        Intent intent = new
                Intent(activity_registrasi.this,MainActivity.class);
